    ...
    export default function LoginPage() {
        ...
        return (
            <div className="flex flex-col min-h-screen px-6 py-[20vh]">
                ...
                <form className="space-y-4 flex flex-col flex-1" onSubmit={handleButtonClick}>
                    <div>
                        <TextInput
                            id="userId"
                            type="text"
                            ...
                            required
                            className="mt-1"
                            style={{ backgroundColor: isUserIdFocused ? '#E7EAF4' : '#F7F7F7', border: 'none', outline: 'none' }}
                            value={userId}
                    ...
                    {errorMessage && <div className="text-red-500">{errorMessage}</div>} {/* 에러 메시지 출력 */}
